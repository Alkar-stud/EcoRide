...
export async function savePreference(id, libelle, description, confirmationMessageId) {
    try {
        const confirmationMessageLoading = document.getElementById(confirmationMessageId + 'Loading'); // Correction orthographique
        ...
        if (response.ok) {
            ...
            if (libelle === 'smokingAllowed') {
                if (description === 'no') {
                    ...
                    document.getElementById("OkSmoke").checked = false;
                } else {
                ...
                if (description === 'no') {
                    ...
                    document.getElementById("OkPet").checked = false;
                } else {
                    document.getElementById("NoPet").checked = false;
